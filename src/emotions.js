...
const CUES = {
  ...
  fear: ['fear', 'afraid', 'anxi', 'anxious', 'worry', 'worried', 'nervous', 'scared', 'dread', 'panic', 'unease', 'apprehens', 'distress', 'overwhelm', 'insecure', 'vulnerab', 'masked distress'],
  curiosity: ['curio', 'interest', 'intrigu', 'inquisit', 'engaged', 'keen', 'attentive', 'exploring', 'wondering why', 'questioning'],
  disgust: ['disgust', 'contempt', 'revuls', 'repuls', 'scorn', 'disdain', 'sneer', 'derisi', 'distaste', 'aversion', 'condescen'],
